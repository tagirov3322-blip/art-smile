...
export default function ToothOverlay() {
  ...
  return (
    ...
    >
      {/* ── Tooth + Glow move together ── */}
      <div className="hero-tooth-scroll relative h-full w-full">
        {/* Glow behind tooth */}
        <div className="absolute inset-0 z-[1]">
          <div
            ...
            style={{
              ...
              borderRadius: "50%",
              background: "radial-gradient(ellipse, rgba(255,220,100,0.85) 0%, rgba(212,175,59,0.5) 40%, transparent 70%)",
              filter: "blur(35px)",
              opacity: 0,
          ...
          <div
            ...
            style={{
              ...
              borderRadius: "50%",
              background: "radial-gradient(ellipse, rgba(212,175,59,0.6) 0%, rgba(196,151,40,0.28) 45%, transparent 70%)",
              filter: "blur(55px)",
              opacity: 0,
              willChange: "transform, opacity",
            }}
          ...
          <div
            ...
            style={{
              ...
              borderRadius: "50%",
              background: "radial-gradient(ellipse, rgba(180,140,30,0.3) 0%, rgba(160,120,20,0.12) 40%, transparent 65%)",
              filter: "blur(80px)",
              opacity: 0,
              willChange: "transform, opacity",
            }}
