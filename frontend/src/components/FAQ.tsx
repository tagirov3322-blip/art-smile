...
const faqItems = [
  { question: "Как записаться на приём?", answer: "Через форму на сайте, по телефону +7 (906) 123-27-27 или в мессенджерах." },
  ...
  { question: "Работаете ли вы по ДМС?", answer: "Да, принимаем пациентов по полисам ДМС." },
  { question: "Какой у вас график работы?", answer: "Пн–Пт: 08:00–20:00 (перерыв 13:00–14:00), Сб: 09:00–15:00, Вс: выходной." },
];
