...
// GET /api/reviews — публичный (только одобренные и видимые)
...
// GET /api/reviews/all — admin (все отзывы, включая неодобренные)
...
// POST /api/reviews — публичный (оставить отзыв с сайта)
...
// PUT /api/reviews/:id — admin (модерация)
router.put("/:id", requireAdmin, validate(moderateReviewSchema), async (req: Request, res: Response) => {
